...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <meta name="description" content="mkdocs-jupyter test site">
      ...
      <meta name="generator" content="mkdocs-1.4.2, mkdocs-material-9.1.2">
        ...
        <title>Variational Inference - site-with-notebooks-and-python-files</title>
      ...
      <link rel="stylesheet" href="../extras/material.css">
...
<header class="md-header md-header--shadow" data-md-component="header">
  <nav class="md-header__inner md-grid" aria-label="Header">
    <a href=".." title="site-with-notebooks-and-python-files" class="md-header__button md-logo" aria-label="site-with-notebooks-and-python-files" data-md-component="logo">
      ...
      <div class="md-header__ellipsis">
        <div class="md-header__topic">
          <span class="md-ellipsis">
            site-with-notebooks-and-python-files
          </span>
        </div>
...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  <label class="md-nav__title" for="__drawer">
    <a href=".." title="site-with-notebooks-and-python-files" class="md-nav__button md-logo" aria-label="site-with-notebooks-and-python-files" data-md-component="logo">
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#intro-to-bayesian-networks" class="md-nav__link">
    Intro to Bayesian Networks
  </a>
  
    <nav class="md-nav" aria-label="Intro to Bayesian Networks">
  ...
  <a href="#probability-distributions" class="md-nav__link">
    Probability Distributions
          ...
          <li class="md-nav__item">
  <a href="#bayesian-networks" class="md-nav__link">
    Bayesian Networks
  </a>
          ...
          <li class="md-nav__item">
  <a href="#bayesian-network-example" class="md-nav__link">
    Bayesian Network Example
          ...
          <li class="md-nav__item">
  <a href="#why-care-about-bayesian-networks" class="md-nav__link">
    Why care about Bayesian Networks
        ...
        <li class="md-nav__item">
  <a href="#intro-to-variational-inference" class="md-nav__link">
    Intro to Variational Inference
  </a>
  
    <nav class="md-nav" aria-label="Intro to Variational Inference">
      <ul class="md-nav__list">
  ...
  <a href="#entropy" class="md-nav__link">
    Entropy
          ...
          <li class="md-nav__item">
  <a href="#entropy-of-normal-distribution" class="md-nav__link">
    Entropy of Normal Distribution
          ...
          <li class="md-nav__item">
  <a href="#kl-divergence" class="md-nav__link">
    KL divergence
  </a>
          ...
          <li class="md-nav__item">
  <a href="#evidence-lower-bound" class="md-nav__link">
    Evidence Lower Bound
        ...
        <li class="md-nav__item">
  <a href="#mean-field-advi" class="md-nav__link">
    Mean Field ADVI
  </a>
  
    <nav class="md-nav" aria-label="Mean Field ADVI">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#transformed-space" class="md-nav__link">
    Transformed Space
  </a>
          ...
          <li class="md-nav__item">
  <a href="#elbo-in-transformed-space" class="md-nav__link">
  ...
  <a href="#lets-code" class="md-nav__link">
    Let's Code
          ...
          <li class="md-nav__item">
  <a href="#transformed-space-example-1" class="md-nav__link">
    Transformed Space Example-1
          ...
          <li class="md-nav__item">
  <a href="#transformed-space-example-2" class="md-nav__link">
    Transformed Space Example-2
          ...
          <li class="md-nav__item">
  <a href="#mean-field-advi-example" class="md-nav__link">
    Mean Field ADVI Example
        ...
        <li class="md-nav__item">
  <a href="#drawbacks-of-this-blog-post" class="md-nav__link">
...
<h1 id="Variational-Inference">Variational Inference<a class="anchor-link" href="#Variational-Inference">&#182;</a></h1><h2 id="Intro-to-Bayesian-Networks">Intro to Bayesian Networks<a class="anchor-link" href="#Intro-to-Bayesian-Networks">&#182;</a></h2><h3 id="Random-Variables">Random Variables<a class="anchor-link" href="#Random-Variables">&#182;</a></h3><p>Random Variables are simply variables whose values are uncertain. Eg -</p>
<ol>
<li><p>In case of flipping a coin $n$ times, a random variable $X$ can be number of heads shown up.</p>
</li>
<li><p>In COVID-19 pandemic situation, random variable can be number of patients found positive with virus daily.</p>
</li>
</ol>
<h3 id="Probability-Distributions">Probability Distributions<a class="anchor-link" href="#Probability-Distributions">&#182;</a></h3><p>Probability Distributions governs the amount of uncertainty of random variables. They have a math function with which they assign probabilities to different values taken by random variables. The associated math function is called probability density function (pdf). For simplicity, let's denote any random variable as $X$ and its corresponding pdf as $P\left (X\right )$. Eg - Following figure shows the probability distribution for number of heads when an unbiased coin is flipped 5 times.</p>
<h3 id="Bayesian-Networks">Bayesian Networks<a class="anchor-link" href="#Bayesian-Networks">&#182;</a></h3><p>Bayesian Networks are graph based representations to acccount for randomness while modelling our data. The nodes of the graph are random variables and the connections between nodes denote the direct influence from parent to child.</p>
<h3 id="Bayesian-Network-Example">Bayesian Network Example<a class="anchor-link" href="#Bayesian-Network-Example">&#182;</a></h3><p>Let's say a student is taking a class during school. The <code>difficulty</code> of the class and the <code>intelligence</code> of the student together directly influence student's <code>grades</code>. And the <code>grades</code> affects his/her acceptance to the university. Also, the <code>intelligence</code> factor influences student's <code>SAT</code> score. Keep this example in mind.</p>
...
<p>The decomposition of running <a href="#bayesian-network-example">Bayesian Network Example</a> can be written as -</p>
$$
...
$$<h3 id="Why-care-about-Bayesian-Networks">Why care about Bayesian Networks<a class="anchor-link" href="#Why-care-about-Bayesian-Networks">&#182;</a></h3><p>Bayesian Networks allow us to determine the distribution of parameters given the data (Posterior Distribution). The whole idea is to model the underlying data generative process and estimate unobservable quantities. Regarding this, Bayes formula can be written as -</p>
$$
P\left (\theta | D\right ) = \frac{P\left (D|\theta\right ) * P\left (\theta\right )}{P\left (D\right )}
$$<p>$\theta$ = Parameters of the model</p>
<p>$P\left (\theta\right )$ = Prior Distribution over the parameters</p>
<p>$P\left (D|\theta\right )$ = Likelihood of the data</p>
<p>$P\left (\theta|D\right )$ = Posterior Distribution</p>
<p>$P\left (D\right )$ = Probability of Data. This term is calculated by marginalising out the effect of parameters.</p>
$$
...
<h2 id="Intro-to-Variational-Inference">Intro to Variational Inference<a class="anchor-link" href="#Intro-to-Variational-Inference">&#182;</a></h2><h3 id="Information">Information<a class="anchor-link" href="#Information">&#182;</a></h3><p>Variational Inference has its origin in Information Theory. So first, let's understand the basic terms - Information and Entropy . Simply, <strong>Information</strong> quantifies how much useful the data is. It is related to Probability Distributions as -</p>
$$
...
<ol>
<li>Consider the statement - It never snows in deserts. The probability of this statement being true is significantly high because we already know that it is hardly possible to snow in deserts. So, the related information is very small.</li>
<li>Now consider - There was a snowfall in Sahara Desert in late December 2019. Wow, thats a great news because some unlikely event occured (probability was less). In turn, the information is high.</li>
</ol>
<h3 id="Entropy">Entropy<a class="anchor-link" href="#Entropy">&#182;</a></h3><p>Entropy quantifies how much <strong>average</strong> Information is present in occurence of events. It is denoted by $H$. It is named Differential Entropy in case of Real Continuous Domain.</p>
$$
H =  E_{P\left (X\right )} \left [-\log\left (P\left (X\right )\right )\right ]\\
H = -\int_X P_X\left (x\right ) \log\left (P_X\left (x\right )\right ) dx
$$<h3 id="Entropy-of-Normal-Distribution">Entropy of Normal Distribution<a class="anchor-link" href="#Entropy-of-Normal-Distribution">&#182;</a></h3><p>As an exercise, let's calculate entropy of Normal Distribution. Let's denote $\mu$ as mean nd $\sigma$ as standard deviation of Normal Distribution. Remember the results, we will need them further.</p>
$$
X \sim Normal\left (\mu, \sigma^2\right )\\
P_X\left (x\right ) = \frac{1}{\sigma \sqrt{2 \pi}} e^{ - \frac{1}{2} \left ({\frac{x- \mu}{ \sigma}}\right )^2}\\
H = -\int_X P_X\left (x\right ) \log\left (P_X\left (x\right )\right ) dx
$$<p>Only expanding $\log\left (P_X\left (x\right )\right )$ -</p>
$$
...
$$<p>Remember? We were stuck upon Bayesian Equation because of denominator term but now, we can estimate the posterior distribution $p(\theta|D)$ by another distribution $q(\theta)$ over all the parameters of the model.</p>
$$
...
<h3 id="Evidence-Lower-Bound">Evidence Lower Bound<a class="anchor-link" href="#Evidence-Lower-Bound">&#182;</a></h3><p>There is again an issue with KL divergence formula as it still involves posterior term i.e. $p(\theta|D)$. Let's get rid of it -</p>
$$
KL(q(\theta)||p(\theta|D)) = \int q(\theta) \log \left( \frac{q(\theta)}{p(\theta|D)} \right) d\theta\\
...
$$<p>The term $\int q(\theta) \log \left( \frac{p(\theta, D)}{q(\theta)} \right) d\theta$ is called Evidence Lower Bound (ELBO). The right side of the equation $\log \left(p(D) \right)$ is constant.</p>
<div class="admonition note">
...
<h3 id="ELBO-in-transformed-Space">ELBO in transformed Space<a class="anchor-link" href="#ELBO-in-transformed-Space">&#182;</a></h3><p>Let's bring back the equation formed at <a href="#evidence-lower-bound">ELBO</a>. Expressing ELBO in terms of $\zeta$ -</p>
$$
ELBO = E_{q(\theta)}\left [\log \left(p(\theta, D) \right) \right] + H_{q(\theta)}\\
ELBO = E_{q(\zeta)}\left [\log \left(p\left (D, T^{-1}\left (\zeta \right) \right) \left | det J_{T^{-1}}(\zeta)  \right | \right) \right] + H_{q(\zeta)}
$$<p>Since, we are optimizing ELBO by factorized Normal Distributions, let's bring back the results of <a href="#entropy-of-normal-distribution">Entropy of Normal Distribution</a>. Our running equation becomes -</p>
$$
ELBO = E_{q(\zeta)}\left [\log \left(p\left (D, T^{-1}\left (\zeta \right) \right) \left | det J_{T^{-1}}(\zeta)  \right | \right) \right] + H_{q(\zeta)}\\
...
<h3 id="Let's-Code">Let's Code<a class="anchor-link" href="#Let's-Code">&#182;</a></h3>
</div>
</div>
</div>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[1]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="n">from</span><span class="w"> </span><span class="n">pprint</span><span class="w"> </span><span class="n">import</span><span class="w"> </span><span class="n">pprint</span>
</pre></div>
<div id="cell-1" class="clipboard-copy-txt">from pprint import pprint</div>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[2]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="n">import</span><span class="w"> </span><span class="n">arviz</span><span class="w"> </span><span class="n">as</span><span class="w"> </span><span class="n">az</span>
<span class="n">import</span><span class="w"> </span><span class="n">matplotlib</span><span class="o">.</span><span class="n">pyplot</span><span class="w"> </span><span class="n">as</span><span class="w"> </span><span class="n">plt</span>
</pre></div>
<div id="cell-2" class="clipboard-copy-txt">import arviz as az
...
<span class="ansi-green-fg">----&gt; 1</span> <span class="ansi-bold" style="color: rgb(0,135,0)">import</span> <span class="ansi-bold" style="color: rgb(0,0,255)">arviz</span> <span class="ansi-bold" style="color: rgb(0,135,0)">as</span> <span class="ansi-bold" style="color: rgb(0,0,255)">az</span>
...
<span class="ansi-red-fg">ModuleNotFoundError</span>: No module named &#39;arviz&#39;</pre>
</div>
</div>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[3]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="c1"># Imports</span>
<span class="o">%</span><span class="n">matplotlib</span><span class="w"> </span><span class="n">inline</span>
<span class="n">import</span><span class="w"> </span><span class="n">numpy</span><span class="w"> </span><span class="n">as</span><span class="w"> </span><span class="n">np</span>
...
<span class="n">import</span><span class="w"> </span><span class="n">pymc3</span><span class="w"> </span><span class="n">as</span><span class="w"> </span><span class="n">pm</span>
<span class="n">import</span><span class="w"> </span><span class="n">scipy</span><span class="w"> </span><span class="n">as</span><span class="w"> </span><span class="n">sp</span>
<span class="n">import</span><span class="w"> </span><span class="n">tensorflow</span><span class="w"> </span><span class="n">as</span><span class="w"> </span><span class="n">tf</span>
<span class="n">import</span><span class="w"> </span><span class="n">tensorflow_probability</span><span class="w"> </span><span class="n">as</span><span class="w"> </span><span class="n">tfp</span>
<span class="n">from</span><span class="w"> </span><span class="n">scipy</span><span class="o">.</span><span class="n">stats</span><span class="w"> </span><span class="n">import</span><span class="w"> </span><span class="n">expon</span><span class="p">,</span><span class="w"> </span><span class="n">uniform</span>
...
<span class="n">from</span><span class="w"> </span><span class="n">tensorflow_probability</span><span class="o">.</span><span class="n">python</span><span class="o">.</span><span class="n">mcmc</span><span class="o">.</span><span class="n">transformed_kernel</span><span class="w"> </span><span class="n">import</span><span class="w"> </span><span class="p">(</span>
<span class="w">    </span><span class="n">make_transform_fn</span><span class="p">,</span>
<span class="w">    </span><span class="n">make_transformed_log_prob</span><span class="p">,</span>
<span class="p">)</span>

<span class="n">tfb</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">tfp</span><span class="o">.</span><span class="n">bijectors</span>
<span class="n">tfd</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">tfp</span><span class="o">.</span><span class="n">distributions</span>
<span class="n">dtype</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">tf</span><span class="o">.</span><span class="n">float32</span>
</pre></div>
<div id="cell-3" class="clipboard-copy-txt"># Imports
%matplotlib inline
import numpy as np
import pandas as pd
import pymc3 as pm
...
<span class="ansi-green-intense-fg ansi-bold">      1</span> <span style="color: rgb(95,135,135)"># Imports</span>
<span class="ansi-green-fg">----&gt; 2</span> <span class="ansi-yellow-bg">get_ipython</span><span class="ansi-yellow-bg">(</span><span class="ansi-yellow-bg">)</span><span class="ansi-yellow-bg" style="color: rgb(98,98,98)">.</span><span class="ansi-yellow-bg">run_line_magic</span><span class="ansi-yellow-bg">(</span><span class="ansi-yellow-bg" style="color: rgb(175,0,0)">&#39;</span><span class="ansi-yellow-bg" style="color: rgb(175,0,0)">matplotlib</span><span class="ansi-yellow-bg" style="color: rgb(175,0,0)">&#39;</span><span class="ansi-yellow-bg">,</span><span class="ansi-yellow-bg"> </span><span class="ansi-yellow-bg" style="color: rgb(175,0,0)">&#39;</span><span class="ansi-yellow-bg" style="color: rgb(175,0,0)">inline</span><span class="ansi-yellow-bg" style="color: rgb(175,0,0)">&#39;</span><span class="ansi-yellow-bg">)</span>
...
<span class="ansi-green-intense-fg ansi-bold">      4</span> <span class="ansi-bold" style="color: rgb(0,135,0)">import</span> <span class="ansi-bold" style="color: rgb(0,0,255)">pandas</span> <span class="ansi-bold" style="color: rgb(0,135,0)">as</span> <span class="ansi-bold" style="color: rgb(0,0,255)">pd</span>

File <span class="ansi-green-fg">~/code/mkdocs-jupyter/.venv/mkdocs-jupyter/lib/python3.10/site-packages/IPython/core/interactiveshell.py:2369</span>, in <span class="ansi-cyan-fg">InteractiveShell.run_line_magic</span><span class="ansi-blue-fg">(self, magic_name, line, _stack_depth)</span>
<span class="ansi-green-intense-fg ansi-bold">   2367</span>     kwargs[<span style="color: rgb(175,0,0)">&#39;</span><span style="color: rgb(175,0,0)">local_ns</span><span style="color: rgb(175,0,0)">&#39;</span>] <span style="color: rgb(98,98,98)">=</span> <span style="color: rgb(0,135,0)">self</span><span style="color: rgb(98,98,98)">.</span>get_local_scope(stack_depth)
<span class="ansi-green-intense-fg ansi-bold">   2368</span> <span class="ansi-bold" style="color: rgb(0,135,0)">with</span> <span style="color: rgb(0,135,0)">self</span><span style="color: rgb(98,98,98)">.</span>builtin_trap:
<span class="ansi-green-fg">-&gt; 2369</span>     result <span style="color: rgb(98,98,98)">=</span> <span class="ansi-yellow-bg">fn</span><span class="ansi-yellow-bg">(</span><span class="ansi-yellow-bg" style="color: rgb(98,98,98)">*</span><span class="ansi-yellow-bg">args</span><span class="ansi-yellow-bg">,</span><span class="ansi-yellow-bg"> </span><span class="ansi-yellow-bg" style="color: rgb(98,98,98)">*</span><span class="ansi-yellow-bg" style="color: rgb(98,98,98)">*</span><span class="ansi-yellow-bg">kwargs</span><span class="ansi-yellow-bg">)</span>
<span class="ansi-green-intense-fg ansi-bold">   2371</span> <span style="color: rgb(95,135,135)"># The code below prevents the output from being displayed</span>
<span class="ansi-green-intense-fg ansi-bold">   2372</span> <span style="color: rgb(95,135,135)"># when using magics with decodator @output_can_be_silenced</span>
<span class="ansi-green-intense-fg ansi-bold">   2373</span> <span style="color: rgb(95,135,135)"># when the last Python token in the expression is a &#39;;&#39;.</span>
<span class="ansi-green-intense-fg ansi-bold">   2374</span> <span class="ansi-bold" style="color: rgb(0,135,0)">if</span> <span style="color: rgb(0,135,0)">getattr</span>(fn, magic<span style="color: rgb(98,98,98)">.</span>MAGIC_OUTPUT_CAN_BE_SILENCED, <span class="ansi-bold" style="color: rgb(0,135,0)">False</span>):

File <span class="ansi-green-fg">~/code/mkdocs-jupyter/.venv/mkdocs-jupyter/lib/python3.10/site-packages/IPython/core/magics/pylab.py:99</span>, in <span class="ansi-cyan-fg">PylabMagics.matplotlib</span><span class="ansi-blue-fg">(self, line)</span>
...
File <span class="ansi-green-fg">~/code/mkdocs-jupyter/.venv/mkdocs-jupyter/lib/python3.10/site-packages/IPython/core/interactiveshell.py:3540</span>, in <span class="ansi-cyan-fg">InteractiveShell.enable_matplotlib</span><span class="ansi-blue-fg">(self, gui)</span>
<span class="ansi-green-intense-fg ansi-bold">   3519</span> <span class="ansi-bold" style="color: rgb(0,135,0)">def</span> <span style="color: rgb(0,0,255)">enable_matplotlib</span>(<span style="color: rgb(0,135,0)">self</span>, gui<span style="color: rgb(98,98,98)">=</span><span class="ansi-bold" style="color: rgb(0,135,0)">None</span>):
<span class="ansi-green-intense-fg ansi-bold">   3520</span> <span style="color: rgb(188,188,188)">    </span><span style="color: rgb(175,0,0)">&#34;&#34;&#34;Enable interactive matplotlib and inline figure support.</span>
<span class="ansi-green-intense-fg ansi-bold">   3521</span> 
<span class="ansi-green-intense-fg ansi-bold">   3522</span> <span style="color: rgb(175,0,0)">    This takes the following steps:</span>
<span class="ansi-green-fg">   (...)</span>
<span class="ansi-green-intense-fg ansi-bold">   3538</span> <span style="color: rgb(175,0,0)">        display figures inline.</span>
<span class="ansi-green-intense-fg ansi-bold">   3539</span> <span style="color: rgb(175,0,0)">    &#34;&#34;&#34;</span>
<span class="ansi-green-fg">-&gt; 3540</span>     <span class="ansi-bold" style="color: rgb(0,135,0)">from</span> <span class="ansi-bold" style="color: rgb(0,0,255)">matplotlib_inline</span><span class="ansi-bold" style="color: rgb(0,0,255)">.</span><span class="ansi-bold" style="color: rgb(0,0,255)">backend_inline</span> <span class="ansi-bold" style="color: rgb(0,135,0)">import</span> configure_inline_support
<span class="ansi-green-intense-fg ansi-bold">   3542</span>     <span class="ansi-bold" style="color: rgb(0,135,0)">from</span> <span class="ansi-bold" style="color: rgb(0,0,255)">IPython</span><span class="ansi-bold" style="color: rgb(0,0,255)">.</span><span class="ansi-bold" style="color: rgb(0,0,255)">core</span> <span class="ansi-bold" style="color: rgb(0,135,0)">import</span> pylabtools <span class="ansi-bold" style="color: rgb(0,135,0)">as</span> pt
<span class="ansi-green-intense-fg ansi-bold">   3543</span>     gui, backend <span style="color: rgb(98,98,98)">=</span> pt<span style="color: rgb(98,98,98)">.</span>find_gui_and_backend(gui, <span style="color: rgb(0,135,0)">self</span><span style="color: rgb(98,98,98)">.</span>pylab_gui_select)

File <span class="ansi-green-fg">~/code/mkdocs-jupyter/.venv/mkdocs-jupyter/lib/python3.10/site-packages/matplotlib_inline/__init__.py:1</span>
...
File <span class="ansi-green-fg">~/code/mkdocs-jupyter/.venv/mkdocs-jupyter/lib/python3.10/site-packages/matplotlib_inline/backend_inline.py:6</span>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[4]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="c1"># Plot functions</span>
<span class="k">def</span><span class="w"> </span><span class="nf">plot_transformation</span><span class="p">(</span><span class="n">theta</span><span class="p">,</span><span class="w"> </span><span class="n">zeta</span><span class="p">,</span><span class="w"> </span><span class="n">p_theta</span><span class="p">,</span><span class="w"> </span><span class="n">p_zeta</span><span class="p">):</span>
<span class="w">    </span><span class="n">fig</span><span class="p">,</span><span class="w"> </span><span class="p">(</span><span class="n">const</span><span class="p">,</span><span class="w"> </span><span class="n">trans</span><span class="p">)</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">plt</span><span class="o">.</span><span class="n">subplots</span><span class="p">(</span><span class="n">nrows</span><span class="o">=</span><span class="mi">2</span><span class="p">,</span><span class="w"> </span><span class="n">ncols</span><span class="o">=</span><span class="mi">1</span><span class="p">,</span><span class="w"> </span><span class="n">figsize</span><span class="o">=</span><span class="p">(</span><span class="mi">6</span><span class="o">.</span><span class="mi">5</span><span class="p">,</span><span class="w"> </span><span class="mi">12</span><span class="p">))</span>
<span class="w">    </span><span class="n">const</span><span class="o">.</span><span class="n">plot</span><span class="p">(</span><span class="n">theta</span><span class="p">,</span><span class="w"> </span><span class="n">p_theta</span><span class="p">,</span><span class="w"> </span><span class="n">color</span><span class="o">=</span><span class="s2">&quot;blue&quot;</span><span class="p">,</span><span class="w"> </span><span class="n">lw</span><span class="o">=</span><span class="mi">2</span><span class="p">)</span>
<span class="w">    </span><span class="n">const</span><span class="o">.</span><span class="n">set_xlabel</span><span class="p">(</span><span class="n">r</span><span class="s2">&quot;$</span><span class="se">\t</span><span class="s2">heta$&quot;</span><span class="p">)</span>
<span class="w">    </span><span class="n">const</span><span class="o">.</span><span class="n">set_ylabel</span><span class="p">(</span><span class="n">r</span><span class="s2">&quot;$P(</span><span class="se">\t</span><span class="s2">heta)$&quot;</span><span class="p">)</span>
<span class="w">    </span><span class="n">const</span><span class="o">.</span><span class="n">set_title</span><span class="p">(</span><span class="s2">&quot;Constrained Space&quot;</span><span class="p">)</span>

<span class="w">    </span><span class="n">trans</span><span class="o">.</span><span class="n">plot</span><span class="p">(</span><span class="n">zeta</span><span class="p">,</span><span class="w"> </span><span class="n">p_zeta</span><span class="p">,</span><span class="w"> </span><span class="n">color</span><span class="o">=</span><span class="s2">&quot;blue&quot;</span><span class="p">,</span><span class="w"> </span><span class="n">lw</span><span class="o">=</span><span class="mi">2</span><span class="p">)</span>
<span class="w">    </span><span class="n">trans</span><span class="o">.</span><span class="n">set_xlabel</span><span class="p">(</span><span class="n">r</span><span class="s2">&quot;$\zeta$&quot;</span><span class="p">)</span>
<span class="w">    </span><span class="n">trans</span><span class="o">.</span><span class="n">set_ylabel</span><span class="p">(</span><span class="n">r</span><span class="s2">&quot;$P(\zeta)$&quot;</span><span class="p">)</span>
<span class="w">    </span><span class="n">trans</span><span class="o">.</span><span class="n">set_title</span><span class="p">(</span><span class="s2">&quot;Transfomed Space&quot;</span><span class="p">)</span>
</pre></div>
<div id="cell-4" class="clipboard-copy-txt"># Plot functions
def plot_transformation(theta, zeta, p_theta, p_zeta):
    ...
    trans.set_title("Transfomed Space")</div>
...
<h3 id="Transformed-Space-Example-1">Transformed Space Example-1<a class="anchor-link" href="#Transformed-Space-Example-1">&#182;</a></h3><p>Transformation of Standard Exponential Distribution</p>
$$
P_X(x) = e^{-x}
$$<p>The support of Exponential Distribution is $x&gt;=0$. Let's use <strong>log</strong> transformation  to map the support to real number line. Mathematically, $\zeta=\log(\theta)$. Now, let's bring back our transformed joint probability distribution equation -</p>
$$
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[5]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="n">theta</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">np</span><span class="o">.</span><span class="n">linspace</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span><span class="w"> </span><span class="mi">5</span><span class="p">,</span><span class="w"> </span><span class="mi">100</span><span class="p">)</span>
<span class="n">zeta</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">np</span><span class="o">.</span><span class="n">linspace</span><span class="p">(</span><span class="o">-</span><span class="mi">5</span><span class="p">,</span><span class="w"> </span><span class="mi">5</span><span class="p">,</span><span class="w"> </span><span class="mi">100</span><span class="p">)</span>

<span class="n">dist</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">expon</span><span class="p">()</span>
<span class="n">p_theta</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">dist</span><span class="o">.</span><span class="n">pdf</span><span class="p">(</span><span class="n">theta</span><span class="p">)</span>
<span class="n">p_zeta</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">dist</span><span class="o">.</span><span class="n">pdf</span><span class="p">(</span><span class="n">np</span><span class="o">.</span><span class="n">exp</span><span class="p">(</span><span class="n">zeta</span><span class="p">))</span><span class="w"> </span><span class="o">*</span><span class="w"> </span><span class="n">np</span><span class="o">.</span><span class="n">exp</span><span class="p">(</span><span class="n">zeta</span><span class="p">)</span>

<span class="n">plot_transformation</span><span class="p">(</span><span class="n">theta</span><span class="p">,</span><span class="w"> </span><span class="n">zeta</span><span class="p">,</span><span class="w"> </span><span class="n">p_theta</span><span class="p">,</span><span class="w"> </span><span class="n">p_zeta</span><span class="p">)</span>
</pre></div>
<div id="cell-5" class="clipboard-copy-txt">theta = np.linspace(0, 5, 100)
...
plot_transformation(theta, zeta, p_theta, p_zeta)</div>
...
<span class="ansi-green-fg">----&gt; 1</span> theta <span style="color: rgb(98,98,98)">=</span> <span class="ansi-yellow-bg">np</span><span style="color: rgb(98,98,98)">.</span>linspace(<span style="color: rgb(98,98,98)">0</span>, <span style="color: rgb(98,98,98)">5</span>, <span style="color: rgb(98,98,98)">100</span>)
<span class="ansi-green-intense-fg ansi-bold">      2</span> zeta <span style="color: rgb(98,98,98)">=</span> np<span style="color: rgb(98,98,98)">.</span>linspace(<span style="color: rgb(98,98,98)">-</span><span style="color: rgb(98,98,98)">5</span>, <span style="color: rgb(98,98,98)">5</span>, <span style="color: rgb(98,98,98)">100</span>)
<span class="ansi-green-intense-fg ansi-bold">      4</span> dist <span style="color: rgb(98,98,98)">=</span> expon()
...
<h3 id="Transformed-Space-Example-2">Transformed Space Example-2<a class="anchor-link" href="#Transformed-Space-Example-2">&#182;</a></h3><p>Transformation of Uniform Distribution (with support $0&lt;=x&lt;=1$)</p>
$$
P_X(x) = 1
$$<p>Let's use <strong>logit</strong> or <strong>inverse sigmoid</strong> transformation to map the support to real number line. Mathematically, $\zeta=logit(\theta)$.</p>
$$
P(\zeta) = P(T^{-1}(\zeta)) |det J_{T^{-1}}(\zeta)|\\
P(\zeta) = P(sig(\zeta)) * sig(\zeta) * (1-sig(\zeta))
$$<p>where $sig$ is the sigmoid function.</p>
<p>Converting this directly into Python code -</p>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[6]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="n">theta</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">np</span><span class="o">.</span><span class="n">linspace</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span><span class="w"> </span><span class="mi">1</span><span class="p">,</span><span class="w"> </span><span class="mi">100</span><span class="p">)</span>
<span class="n">zeta</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">np</span><span class="o">.</span><span class="n">linspace</span><span class="p">(</span><span class="o">-</span><span class="mi">5</span><span class="p">,</span><span class="w"> </span><span class="mi">5</span><span class="p">,</span><span class="w"> </span><span class="mi">100</span><span class="p">)</span>

<span class="n">dist</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">uniform</span><span class="p">()</span>
<span class="n">p_theta</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">dist</span><span class="o">.</span><span class="n">pdf</span><span class="p">(</span><span class="n">theta</span><span class="p">)</span>
<span class="n">sigmoid</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">sp</span><span class="o">.</span><span class="n">special</span><span class="o">.</span><span class="n">expit</span>
<span class="n">p_zeta</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">dist</span><span class="o">.</span><span class="n">pdf</span><span class="p">(</span><span class="n">sigmoid</span><span class="p">(</span><span class="n">zeta</span><span class="p">))</span><span class="w"> </span><span class="o">*</span><span class="w"> </span><span class="n">sigmoid</span><span class="p">(</span><span class="n">zeta</span><span class="p">)</span><span class="w"> </span><span class="o">*</span><span class="w"> </span><span class="p">(</span><span class="mi">1</span><span class="w"> </span><span class="o">-</span><span class="w"> </span><span class="n">sigmoid</span><span class="p">(</span><span class="n">zeta</span><span class="p">))</span>

<span class="n">plot_transformation</span><span class="p">(</span><span class="n">theta</span><span class="p">,</span><span class="w"> </span><span class="n">zeta</span><span class="p">,</span><span class="w"> </span><span class="n">p_theta</span><span class="p">,</span><span class="w"> </span><span class="n">p_zeta</span><span class="p">)</span>
</pre></div>
<div id="cell-6" class="clipboard-copy-txt">theta = np.linspace(0, 1, 100)
zeta = np.linspace(-5, 5, 100)
...
<span class="ansi-green-fg">----&gt; 1</span> theta <span style="color: rgb(98,98,98)">=</span> <span class="ansi-yellow-bg">np</span><span style="color: rgb(98,98,98)">.</span>linspace(<span style="color: rgb(98,98,98)">0</span>, <span style="color: rgb(98,98,98)">1</span>, <span style="color: rgb(98,98,98)">100</span>)
<span class="ansi-green-intense-fg ansi-bold">      2</span> zeta <span style="color: rgb(98,98,98)">=</span> np<span style="color: rgb(98,98,98)">.</span>linspace(<span style="color: rgb(98,98,98)">-</span><span style="color: rgb(98,98,98)">5</span>, <span style="color: rgb(98,98,98)">5</span>, <span style="color: rgb(98,98,98)">100</span>)
<span class="ansi-green-intense-fg ansi-bold">      4</span> dist <span style="color: rgb(98,98,98)">=</span> uniform()
...
<h3 id="Mean-Field-ADVI-Example">Mean Field ADVI Example<a class="anchor-link" href="#Mean-Field-ADVI-Example">&#182;</a></h3><p>Infer $\mu$ and $\sigma$ for Normal distribution.</p>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[7]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="c1"># Generating data</span>
<span class="n">mu</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mi">12</span>
<span class="n">sigma</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="mi">2</span><span class="o">.</span><span class="mi">2</span>
<span class="n">data</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">np</span><span class="o">.</span><span class="n">random</span><span class="o">.</span><span class="n">normal</span><span class="p">(</span><span class="n">mu</span><span class="p">,</span><span class="w"> </span><span class="n">sigma</span><span class="p">,</span><span class="w"> </span><span class="n">size</span><span class="o">=</span><span class="mi">200</span><span class="p">)</span>
</pre></div>
<div id="cell-7" class="clipboard-copy-txt"># Generating data
mu = 12
sigma = 2.2
data = np.random.normal(mu, sigma, size=200)</div>
...
<span class="ansi-green-intense-fg ansi-bold">      2</span> mu <span style="color: rgb(98,98,98)">=</span> <span style="color: rgb(98,98,98)">12</span>
<span class="ansi-green-intense-fg ansi-bold">      3</span> sigma <span style="color: rgb(98,98,98)">=</span> <span style="color: rgb(98,98,98)">2.2</span>
<span class="ansi-green-fg">----&gt; 4</span> data <span style="color: rgb(98,98,98)">=</span> <span class="ansi-yellow-bg">np</span><span style="color: rgb(98,98,98)">.</span>random<span style="color: rgb(98,98,98)">.</span>normal(mu, sigma, size<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(98,98,98)">200</span>)
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[8]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="c1"># Defining the model</span>
<span class="n">model</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">tfd</span><span class="o">.</span><span class="n">JointDistributionSequential</span><span class="p">(</span>
<span class="w">    </span><span class="o">[</span>
<span class="w">        </span><span class="c1"># sigma_prior</span>
<span class="w">        </span><span class="n">tfd</span><span class="o">.</span><span class="n">Exponential</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span><span class="w"> </span><span class="nb">name</span><span class="o">=</span><span class="s2">&quot;sigma&quot;</span><span class="p">),</span>
<span class="w">        </span><span class="c1"># mu_prior</span>
<span class="w">        </span><span class="n">tfd</span><span class="o">.</span><span class="n">Normal</span><span class="p">(</span><span class="n">loc</span><span class="o">=</span><span class="mi">0</span><span class="p">,</span><span class="w"> </span><span class="n">scale</span><span class="o">=</span><span class="mi">10</span><span class="p">,</span><span class="w"> </span><span class="nb">name</span><span class="o">=</span><span class="s2">&quot;mu&quot;</span><span class="p">),</span>
<span class="w">        </span><span class="c1"># likelihood</span>
<span class="w">        </span><span class="nb">lambda</span><span class="w"> </span><span class="n">mu</span><span class="p">,</span><span class="w"> </span><span class="ss">sigma</span><span class="p">:</span><span class="w"> </span><span class="n">tfd</span><span class="o">.</span><span class="n">Normal</span><span class="p">(</span><span class="n">loc</span><span class="o">=</span><span class="n">mu</span><span class="p">,</span><span class="w"> </span><span class="n">scale</span><span class="o">=</span><span class="n">sigma</span><span class="p">),</span>
<span class="w">    </span><span class="o">]</span>
<span class="p">)</span>
</pre></div>
<div id="cell-8" class="clipboard-copy-txt"># Defining the model
...
<span class="ansi-green-intense-fg ansi-bold">      1</span> <span style="color: rgb(95,135,135)"># Defining the model</span>
<span class="ansi-green-fg">----&gt; 2</span> model <span style="color: rgb(98,98,98)">=</span> <span class="ansi-yellow-bg">tfd</span><span style="color: rgb(98,98,98)">.</span>JointDistributionSequential(
<span class="ansi-green-intense-fg ansi-bold">      3</span>     [
<span class="ansi-green-intense-fg ansi-bold">      4</span>         <span style="color: rgb(95,135,135)"># sigma_prior</span>
<span class="ansi-green-intense-fg ansi-bold">      5</span>         tfd<span style="color: rgb(98,98,98)">.</span>Exponential(<span style="color: rgb(98,98,98)">1</span>, name<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(175,0,0)">&#34;</span><span style="color: rgb(175,0,0)">sigma</span><span style="color: rgb(175,0,0)">&#34;</span>),
<span class="ansi-green-intense-fg ansi-bold">      6</span>         <span style="color: rgb(95,135,135)"># mu_prior</span>
<span class="ansi-green-intense-fg ansi-bold">      7</span>         tfd<span style="color: rgb(98,98,98)">.</span>Normal(loc<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(98,98,98)">0</span>, scale<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(98,98,98)">10</span>, name<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(175,0,0)">&#34;</span><span style="color: rgb(175,0,0)">mu</span><span style="color: rgb(175,0,0)">&#34;</span>),
<span class="ansi-green-intense-fg ansi-bold">      8</span>         <span style="color: rgb(95,135,135)"># likelihood</span>
<span class="ansi-green-intense-fg ansi-bold">      9</span>         <span class="ansi-bold" style="color: rgb(0,135,0)">lambda</span> mu, sigma: tfd<span style="color: rgb(98,98,98)">.</span>Normal(loc<span style="color: rgb(98,98,98)">=</span>mu, scale<span style="color: rgb(98,98,98)">=</span>sigma),
<span class="ansi-green-intense-fg ansi-bold">     10</span>     ]
<span class="ansi-green-intense-fg ansi-bold">     11</span> )

<span class="ansi-red-fg">NameError</span>: name &#39;tfd&#39; is not defined</pre>
</div>
</div>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[9]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="n">model</span><span class="o">.</span><span class="n">resolve_graph</span><span class="p">())</span>
</pre></div>
<div id="cell-9" class="clipboard-copy-txt">print(model.resolve_graph())</div>
...
<span class="ansi-green-fg">----&gt; 1</span> <span style="color: rgb(0,135,0)">print</span>(<span class="ansi-yellow-bg">model</span><span style="color: rgb(98,98,98)">.</span>resolve_graph())
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[10]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="c1"># Let&#39;s generate joint log probability</span>
<span class="n">joint_log_prob</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nb">lambda</span><span class="w"> </span><span class="o">*</span><span class="ss">x</span><span class="p">:</span><span class="w"> </span><span class="n">model</span><span class="o">.</span><span class="n">log_prob</span><span class="p">(</span><span class="n">x</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="p">(</span><span class="n">data</span><span class="p">,))</span>
</pre></div>
<div id="cell-10" class="clipboard-copy-txt"># Let's generate joint log probability
joint_log_prob = lambda *x: model.log_prob(x + (data,))</div>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[11]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="c1"># Build Mean Field ADVI</span>
<span class="k">def</span><span class="w"> </span><span class="nf">build_mf_advi</span><span class="p">():</span>
<span class="w">    </span><span class="n">parameters</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">model</span><span class="o">.</span><span class="n">sample</span><span class="p">(</span><span class="mi">1</span><span class="p">)</span>
<span class="w">    </span><span class="n">parameters</span><span class="o">.</span><span class="n">pop</span><span class="p">()</span>
<span class="w">    </span><span class="n">dists</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="o">[]</span>
<span class="w">    </span><span class="k">for</span><span class="w"> </span><span class="n">i</span><span class="p">,</span><span class="w"> </span><span class="n">parameter</span><span class="w"> </span><span class="k">in</span><span class="w"> </span><span class="n">enumerate</span><span class="p">(</span><span class="n">parameters</span><span class="p">):</span>
<span class="w">        </span><span class="n">shape</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">parameter</span><span class="o">[</span><span class="mi">0</span><span class="o">].</span><span class="n">shape</span>
<span class="w">        </span><span class="n">loc</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">tf</span><span class="o">.</span><span class="n">Variable</span><span class="p">(</span>
<span class="w">            </span><span class="n">tf</span><span class="o">.</span><span class="n">random</span><span class="o">.</span><span class="n">normal</span><span class="p">(</span><span class="n">shape</span><span class="p">,</span><span class="w"> </span><span class="n">dtype</span><span class="o">=</span><span class="n">dtype</span><span class="p">),</span>
<span class="w">            </span><span class="nb">name</span><span class="o">=</span><span class="n">f</span><span class="s2">&quot;meanfield_{i}_loc&quot;</span><span class="p">,</span>
<span class="w">            </span><span class="n">dtype</span><span class="o">=</span><span class="n">dtype</span><span class="p">,</span>
<span class="w">        </span><span class="p">)</span>
<span class="w">        </span><span class="n">scale</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">tfp</span><span class="o">.</span><span class="n">util</span><span class="o">.</span><span class="n">TransformedVariable</span><span class="p">(</span>
<span class="w">            </span><span class="n">tf</span><span class="o">.</span><span class="n">fill</span><span class="p">(</span><span class="n">shape</span><span class="p">,</span><span class="w"> </span><span class="n">value</span><span class="o">=</span><span class="n">tf</span><span class="o">.</span><span class="n">constant</span><span class="p">(</span><span class="mi">0</span><span class="o">.</span><span class="mo">02</span><span class="p">,</span><span class="w"> </span><span class="n">dtype</span><span class="o">=</span><span class="n">dtype</span><span class="p">)),</span>
<span class="w">            </span><span class="n">tfb</span><span class="o">.</span><span class="n">Softplus</span><span class="p">(),</span><span class="w">  </span><span class="c1"># For positive values of scale</span>
<span class="w">            </span><span class="nb">name</span><span class="o">=</span><span class="n">f</span><span class="s2">&quot;meanfield_{i}_scale&quot;</span><span class="p">,</span>
<span class="w">        </span><span class="p">)</span>

<span class="w">        </span><span class="n">approx_parameter</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">tfd</span><span class="o">.</span><span class="n">Normal</span><span class="p">(</span><span class="n">loc</span><span class="o">=</span><span class="n">loc</span><span class="p">,</span><span class="w"> </span><span class="n">scale</span><span class="o">=</span><span class="n">scale</span><span class="p">)</span>
<span class="w">        </span><span class="n">dists</span><span class="o">.</span><span class="n">append</span><span class="p">(</span><span class="n">approx_parameter</span><span class="p">)</span>
<span class="w">    </span><span class="k">return</span><span class="w"> </span><span class="n">tfd</span><span class="o">.</span><span class="n">JointDistributionSequential</span><span class="p">(</span><span class="n">dists</span><span class="p">)</span>


<span class="n">meanfield_advi</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">build_mf_advi</span><span class="p">()</span>
</pre></div>
<div id="cell-11" class="clipboard-copy-txt"># Build Mean Field ADVI
def build_mf_advi():
...
meanfield_advi = build_mf_advi()</div>
...
<span class="ansi-red-fg">---------------------------------------------------------------------------</span>
<span class="ansi-red-fg">NameError</span>                                 Traceback (most recent call last)
Cell <span class="ansi-green-fg">In[11], line 24</span>
<span class="ansi-green-intense-fg ansi-bold">     20</span>         dists<span style="color: rgb(98,98,98)">.</span>append(approx_parameter)
<span class="ansi-green-intense-fg ansi-bold">     21</span>     <span class="ansi-bold" style="color: rgb(0,135,0)">return</span> tfd<span style="color: rgb(98,98,98)">.</span>JointDistributionSequential(dists)
<span class="ansi-green-fg">---&gt; 24</span> meanfield_advi <span style="color: rgb(98,98,98)">=</span> <span class="ansi-yellow-bg">build_mf_advi</span><span class="ansi-yellow-bg">(</span><span class="ansi-yellow-bg">)</span>

Cell <span class="ansi-green-fg">In[11], line 3</span>, in <span class="ansi-cyan-fg">build_mf_advi</span><span class="ansi-blue-fg">()</span>
<span class="ansi-green-intense-fg ansi-bold">      2</span> <span class="ansi-bold" style="color: rgb(0,135,0)">def</span> <span style="color: rgb(0,0,255)">build_mf_advi</span>():
<span class="ansi-green-fg">----&gt; 3</span>     parameters <span style="color: rgb(98,98,98)">=</span> <span class="ansi-yellow-bg">model</span><span style="color: rgb(98,98,98)">.</span>sample(<span style="color: rgb(98,98,98)">1</span>)
<span class="ansi-green-intense-fg ansi-bold">      4</span>     parameters<span style="color: rgb(98,98,98)">.</span>pop()
<span class="ansi-green-intense-fg ansi-bold">      5</span>     dists <span style="color: rgb(98,98,98)">=</span> []
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[12]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="n">unconstraining_bijectors</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="o">[</span><span class="n">tfb</span><span class="o">.</span><span class="n">Exp</span><span class="p">(),</span><span class="w"> </span><span class="n">tfb</span><span class="o">.</span><span class="n">Identity</span><span class="p">()</span><span class="o">]</span>

<span class="n">posterior</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">make_transformed_log_prob</span><span class="p">(</span>
<span class="w">    </span><span class="n">joint_log_prob</span><span class="p">,</span>
<span class="w">    </span><span class="n">unconstraining_bijectors</span><span class="p">,</span>
<span class="w">    </span><span class="n">direction</span><span class="o">=</span><span class="s2">&quot;forward&quot;</span><span class="p">,</span>
<span class="w">    </span><span class="n">enable_bijector_caching</span><span class="o">=</span><span class="no">False</span><span class="p">,</span>
<span class="p">)</span>
</pre></div>
<div id="cell-12" class="clipboard-copy-txt">unconstraining_bijectors = [tfb.Exp(), tfb.Identity()]
...
<span class="ansi-green-fg">----&gt; 1</span> unconstraining_bijectors <span style="color: rgb(98,98,98)">=</span> [<span class="ansi-yellow-bg">tfb</span><span style="color: rgb(98,98,98)">.</span>Exp(), tfb<span style="color: rgb(98,98,98)">.</span>Identity()]
<span class="ansi-green-intense-fg ansi-bold">      3</span> posterior <span style="color: rgb(98,98,98)">=</span> make_transformed_log_prob(
<span class="ansi-green-intense-fg ansi-bold">      4</span>     joint_log_prob,
<span class="ansi-green-intense-fg ansi-bold">      5</span>     unconstraining_bijectors,
<span class="ansi-green-intense-fg ansi-bold">      6</span>     direction<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(175,0,0)">&#34;</span><span style="color: rgb(175,0,0)">forward</span><span style="color: rgb(175,0,0)">&#34;</span>,
<span class="ansi-green-intense-fg ansi-bold">      7</span>     enable_bijector_caching<span style="color: rgb(98,98,98)">=</span><span class="ansi-bold" style="color: rgb(0,135,0)">False</span>,
<span class="ansi-green-intense-fg ansi-bold">      8</span> )

<span class="ansi-red-fg">NameError</span>: name &#39;tfb&#39; is not defined</pre>
</div>
</div>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[13]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="n">opt</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">tf</span><span class="o">.</span><span class="n">optimizers</span><span class="o">.</span><span class="n">Adam</span><span class="p">(</span><span class="n">learning_rate</span><span class="o">=</span><span class="mi">0</span><span class="o">.</span><span class="mi">1</span><span class="p">)</span>


<span class="vi">@tf</span><span class="o">.</span><span class="n">function</span><span class="p">(</span><span class="n">autograph</span><span class="o">=</span><span class="no">False</span><span class="p">)</span>
<span class="k">def</span><span class="w"> </span><span class="nf">run_approximation</span><span class="p">():</span>
<span class="w">    </span><span class="n">elbo_loss</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">tfp</span><span class="o">.</span><span class="n">vi</span><span class="o">.</span><span class="n">fit_surrogate_posterior</span><span class="p">(</span>
<span class="w">        </span><span class="n">posterior</span><span class="p">,</span>
<span class="w">        </span><span class="n">surrogate_posterior</span><span class="o">=</span><span class="n">meanfield_advi</span><span class="p">,</span>
<span class="w">        </span><span class="n">optimizer</span><span class="o">=</span><span class="n">opt</span><span class="p">,</span>
<span class="w">        </span><span class="n">sample_size</span><span class="o">=</span><span class="mi">200</span><span class="p">,</span>
<span class="w">        </span><span class="n">num_steps</span><span class="o">=</span><span class="mi">10000</span><span class="p">,</span>
<span class="w">    </span><span class="p">)</span>
<span class="w">    </span><span class="k">return</span><span class="w"> </span><span class="n">elbo_loss</span>


<span class="n">elbo_loss</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">run_approximation</span><span class="p">()</span>
</pre></div>
<div id="cell-13" class="clipboard-copy-txt">opt = tf.optimizers.Adam(learning_rate=0.1)
...
elbo_loss = run_approximation()</div>
...
<span class="ansi-green-fg">----&gt; 1</span> opt <span style="color: rgb(98,98,98)">=</span> <span class="ansi-yellow-bg">tf</span><span style="color: rgb(98,98,98)">.</span>optimizers<span style="color: rgb(98,98,98)">.</span>Adam(learning_rate<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(98,98,98)">0.1</span>)
<span class="ansi-green-intense-fg ansi-bold">      4</span> <span style="color: rgb(175,0,255)">@tf</span><span style="color: rgb(98,98,98)">.</span>function(autograph<span style="color: rgb(98,98,98)">=</span><span class="ansi-bold" style="color: rgb(0,135,0)">False</span>)
<span class="ansi-green-intense-fg ansi-bold">      5</span> <span class="ansi-bold" style="color: rgb(0,135,0)">def</span> <span style="color: rgb(0,0,255)">run_approximation</span>():
<span class="ansi-green-intense-fg ansi-bold">      6</span>     elbo_loss <span style="color: rgb(98,98,98)">=</span> tfp<span style="color: rgb(98,98,98)">.</span>vi<span style="color: rgb(98,98,98)">.</span>fit_surrogate_posterior(
<span class="ansi-green-intense-fg ansi-bold">      7</span>         posterior,
<span class="ansi-green-intense-fg ansi-bold">      8</span>         surrogate_posterior<span style="color: rgb(98,98,98)">=</span>meanfield_advi,
<span class="ansi-green-fg">   (...)</span>
<span class="ansi-green-intense-fg ansi-bold">     11</span>         num_steps<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(98,98,98)">10000</span>,
<span class="ansi-green-intense-fg ansi-bold">     12</span>     )

<span class="ansi-red-fg">NameError</span>: name &#39;tf&#39; is not defined</pre>
</div>
</div>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[14]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="n">plt</span><span class="o">.</span><span class="n">plot</span><span class="p">(</span><span class="n">elbo_loss</span><span class="p">,</span><span class="w"> </span><span class="n">color</span><span class="o">=</span><span class="s2">&quot;blue&quot;</span><span class="p">)</span>
...
<div id="cell-14" class="clipboard-copy-txt">plt.plot(elbo_loss, color="blue")
...
<span class="ansi-green-fg">----&gt; 1</span> <span class="ansi-yellow-bg">plt</span><span style="color: rgb(98,98,98)">.</span>plot(elbo_loss, color<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(175,0,0)">&#34;</span><span style="color: rgb(175,0,0)">blue</span><span style="color: rgb(175,0,0)">&#34;</span>)
<span class="ansi-green-intense-fg ansi-bold">      2</span> plt<span style="color: rgb(98,98,98)">.</span>xlabel(<span style="color: rgb(175,0,0)">&#34;</span><span style="color: rgb(175,0,0)">No of iterations</span><span style="color: rgb(175,0,0)">&#34;</span>)
<span class="ansi-green-intense-fg ansi-bold">      3</span> plt<span style="color: rgb(98,98,98)">.</span>ylabel(<span style="color: rgb(175,0,0)">&#34;</span><span style="color: rgb(175,0,0)">Negative ELBO</span><span style="color: rgb(175,0,0)">&#34;</span>)
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[15]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="n">graph_info</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">model</span><span class="o">.</span><span class="n">resolve_graph</span><span class="p">()</span>
<span class="n">approx_param</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">dict</span><span class="p">()</span>
<span class="n">free_param</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="n">meanfield_advi</span><span class="o">.</span><span class="n">trainable_variables</span>
<span class="k">for</span><span class="w"> </span><span class="n">i</span><span class="p">,</span><span class="w"> </span><span class="p">(</span><span class="n">rvname</span><span class="p">,</span><span class="w"> </span><span class="n">param</span><span class="p">)</span><span class="w"> </span><span class="k">in</span><span class="w"> </span><span class="n">enumerate</span><span class="p">(</span><span class="n">graph_info</span><span class="o">[</span><span class="ss">:-</span><span class="mi">1</span><span class="o">]</span><span class="p">):</span>
<span class="w">    </span><span class="n">approx_param</span><span class="o">[</span><span class="n">rvname</span><span class="o">]</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="s2">&quot;mu&quot;</span><span class="p">:</span><span class="w"> </span><span class="n">free_param</span><span class="o">[</span><span class="n">i</span><span class="w"> </span><span class="o">*</span><span class="w"> </span><span class="mi">2</span><span class="o">].</span><span class="n">numpy</span><span class="p">(),</span>
<span class="w">        </span><span class="s2">&quot;sd&quot;</span><span class="p">:</span><span class="w"> </span><span class="n">free_param</span><span class="o">[</span><span class="n">i</span><span class="w"> </span><span class="o">*</span><span class="w"> </span><span class="mi">2</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="mi">1</span><span class="o">].</span><span class="n">numpy</span><span class="p">(),</span>
<span class="w">    </span><span class="p">}</span>
</pre></div>
<div id="cell-15" class="clipboard-copy-txt">graph_info = model.resolve_graph()
approx_param = dict()
...
<span class="ansi-green-fg">----&gt; 1</span> graph_info <span style="color: rgb(98,98,98)">=</span> <span class="ansi-yellow-bg">model</span><span style="color: rgb(98,98,98)">.</span>resolve_graph()
<span class="ansi-green-intense-fg ansi-bold">      2</span> approx_param <span style="color: rgb(98,98,98)">=</span> <span style="color: rgb(0,135,0)">dict</span>()
<span class="ansi-green-intense-fg ansi-bold">      3</span> free_param <span style="color: rgb(98,98,98)">=</span> meanfield_advi<span style="color: rgb(98,98,98)">.</span>trainable_variables
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[16]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-ruby"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="n">approx_param</span><span class="p">)</span>
</pre></div>
<div id="cell-16" class="clipboard-copy-txt">print(approx_param)</div>
...
<span class="ansi-green-fg">----&gt; 1</span> <span style="color: rgb(0,135,0)">print</span>(<span class="ansi-yellow-bg">approx_param</span>)

<span class="ansi-red-fg">NameError</span>: name &#39;approx_param&#39; is not defined</pre>
</div>
</div>
...
<h2 id="Drawbacks-of-this-blog-post">Drawbacks of this blog post<a class="anchor-link" href="#Drawbacks-of-this-blog-post">&#182;</a></h2><ol>
<li>I have not used consistent notation for probability density functions (pdfs). Because I like equations handled this way.</li>
<li>Coming up with more good examples using minibatches.</li>
<li>The ADVI papers also mention Elliptical standardization and Adaptive step size for optimizers. I have not understood those sections well and thus, haven't tried to implement them.</li>
</ol>
<h2 id="References">References<a class="anchor-link" href="#References">&#182;</a></h2><ul>
<li>Chapter 1 and 2: <a href="">Probabilistic Graphical Model Book</a></li>
<li>Blog Post: <a href="https://ericmjl.github.io/essays-on-data-science/machine-learning/computational-bayesian-stats/">An Introduction to Probability and Computational Bayesian Statistics</a> by <a href="https://github.com/ericmjl">Ericmjl</a></li>
<li>Section 10.1: Variational Inference <a href="http://users.isr.ist.utl.pt/~wurmd/Livros/school/Bishop%20-%20Pattern%20Recognition%20And%20Machine%20Learning%20-%20Springer%20%202006.pdf">Pattern Recognition and Machine Learning Book</a></li>
<li>Section 2.5: Transformations <a href="http://www.ru.ac.bd/stat/wp-content/uploads/sites/25/2019/03/501_09_00_Olive-Statistical-Theory-and-Inference-2014.pdf">Statistical Theory and Inference Book</a></li>
<li>YouTube: <a href="https://www.youtube.com/watch?v=3KGZDC3-_iY">Variational Inference in Python</a> by <a href="https://github.com/AustinRochford">Austin Rochford</a></li>
<li>PyMC4: <a href="https://github.com/pymc-devs/pymc4/blob/master/notebooks/basic-usage.ipynb">Basic Usage Notebook</a></li>
<li>TFP: <a href="https://github.com/tensorflow/probability/blob/master/tensorflow_probability/examples/jupyter_notebooks/Modeling_with_JointDistribution.ipynb">Joint Modelling Notebook</a></li>
<li>Papers:<ul>
<li><a href="https://arxiv.org/pdf/1603.00788.pdf">Automatic Differentiation Variational Inference</a>. Kucukelbir, A., Tran, D., Ranganath, R., Gelman, A., and Blei, D. M. (2016).</li>
<li><a href="https://arxiv.org/abs/1506.03431">Automatic Variational Inference in Stan</a>. Kucukelbir, A., Ranganath, R., Gelman, A., &amp; Blei, D. (2015).</li>
</ul>
</li>
</ul>
<h2 id="Special-Thanks">Special Thanks<a class="anchor-link" href="#Special-Thanks">&#182;</a></h2><ul>
<li>Website: <a href="https://www.codecogs.com/latex/eqneditor.php">codecogs.com</a> to help me generate LaTeX equations.</li>
<li>Comments: <a href="https://github.com/pymc-devs/pymc4/issues/258#issue-626833042">#1</a> and <a href="https://github.com/pymc-devs/pymc4/pull/246#issuecomment-632051325">#2</a> by <a href="https://github.com/lucianopaz">Luciano Paz</a> that cleared my all doubts regarding transformations.</li>
</ul>

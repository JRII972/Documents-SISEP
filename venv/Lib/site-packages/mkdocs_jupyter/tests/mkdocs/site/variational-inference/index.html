...
<nav class="md-nav md-nav--primary" aria-label="Navigation" data-md-level="0">
  ...
  <ul class="md-nav__list" data-md-scrollfix>
    ...
    <li class="md-nav__item">
      <a href="../variational-inference-script/" class="md-nav__link">
        Variational Inference
      </a>
    </li>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[1]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="c1"># Imports</span>
<span class="o">%</span><span class="n">matplotlib</span> <span class="n">inline</span>
<span class="kn">import</span> <span class="nn">numpy</span> <span class="k">as</span> <span class="nn">np</span>
<span class="kn">import</span> <span class="nn">scipy</span> <span class="k">as</span> <span class="nn">sp</span>
<span class="kn">import</span> <span class="nn">pandas</span> <span class="k">as</span> <span class="nn">pd</span>
<span class="kn">import</span> <span class="nn">tensorflow</span> <span class="k">as</span> <span class="nn">tf</span>
<span class="kn">from</span> <span class="nn">scipy.stats</span> <span class="kn">import</span> <span class="n">expon</span><span class="p">,</span> <span class="n">uniform</span>
...
<span class="kn">from</span> <span class="nn">tensorflow_probability.python.mcmc.transformed_kernel</span> <span class="kn">import</span> <span class="p">(</span>
...
<div id="cell-1" class="clipboard-copy-txt"># Imports
%matplotlib inline
import numpy as np
import scipy as sp
import pandas as pd
...
<span class="ansi-green-intense-fg ansi-bold">      4</span> <span class="ansi-bold" style="color: rgb(0,135,0)">import</span> <span class="ansi-bold" style="color: rgb(0,0,255)">scipy</span> <span class="ansi-bold" style="color: rgb(0,135,0)">as</span> <span class="ansi-bold" style="color: rgb(0,0,255)">sp</span>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[2]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="c1"># Plot functions</span>
<span class="k">def</span> <span class="nf">plot_transformation</span><span class="p">(</span><span class="n">theta</span><span class="p">,</span> <span class="n">zeta</span><span class="p">,</span> <span class="n">p_theta</span><span class="p">,</span> <span class="n">p_zeta</span><span class="p">):</span>
    ...
    <span class="n">trans</span><span class="o">.</span><span class="n">set_title</span><span class="p">(</span><span class="s2">&quot;Transfomed Space&quot;</span><span class="p">);</span>
</pre></div>
<div id="cell-2" class="clipboard-copy-txt"># Plot functions
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[3]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="n">theta</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">linspace</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">5</span><span class="p">,</span> <span class="mi">100</span><span class="p">)</span>
...
<div id="cell-3" class="clipboard-copy-txt">theta = np.linspace(0, 5, 100)
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[4]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="n">theta</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">linspace</span><span class="p">(</span><span class="mi">0</span><span class="p">,</span> <span class="mi">1</span><span class="p">,</span> <span class="mi">100</span><span class="p">)</span>
<span class="n">zeta</span> <span class="o">=</span> <span class="n">np</span><span class="o">.</span><span class="n">linspace</span><span class="p">(</span><span class="o">-</span><span class="mi">5</span><span class="p">,</span> <span class="mi">5</span><span class="p">,</span> <span class="mi">100</span><span class="p">)</span>
...
<div id="cell-4" class="clipboard-copy-txt">theta = np.linspace(0, 1, 100)
zeta = np.linspace(-5, 5, 100)
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[5]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="c1"># Generating data</span>
...
<div id="cell-5" class="clipboard-copy-txt"># Generating data
mu = 12
sigma = 2.2
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[6]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="c1"># Defining the model</span>
...
<div id="cell-6" class="clipboard-copy-txt"># Defining the model
...
<span class="ansi-green-intense-fg ansi-bold">      3</span>     <span style="color: rgb(95,135,135)"># sigma_prior</span>
<span class="ansi-green-intense-fg ansi-bold">      4</span>     tfd<span style="color: rgb(98,98,98)">.</span>Exponential(<span style="color: rgb(98,98,98)">1</span>, name<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(175,0,0)">&#39;</span><span style="color: rgb(175,0,0)">sigma</span><span style="color: rgb(175,0,0)">&#39;</span>),                               
...
<span class="ansi-green-intense-fg ansi-bold">      9</span>     <span style="color: rgb(95,135,135)"># likelihood</span>
<span class="ansi-green-intense-fg ansi-bold">     10</span>     <span class="ansi-bold" style="color: rgb(0,135,0)">lambda</span> mu, sigma: tfd<span style="color: rgb(98,98,98)">.</span>Normal(loc<span style="color: rgb(98,98,98)">=</span>mu, scale<span style="color: rgb(98,98,98)">=</span>sigma)
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[7]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="n">model</span><span class="o">.</span><span class="n">resolve_graph</span><span class="p">())</span>
</pre></div>
<div id="cell-7" class="clipboard-copy-txt">print(model.resolve_graph())</div>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[8]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="c1"># Let&#39;s generate joint log probability</span>
...
<div id="cell-8" class="clipboard-copy-txt"># Let's generate joint log probability
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[9]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="c1"># Build Mean Field ADVI</span>
<span class="k">def</span> <span class="nf">build_mf_advi</span><span class="p">():</span>
...
<div id="cell-9" class="clipboard-copy-txt"># Build Mean Field ADVI
def build_mf_advi():
...
<span class="ansi-red-fg">---------------------------------------------------------------------------</span>
<span class="ansi-red-fg">NameError</span>                                 Traceback (most recent call last)
Cell <span class="ansi-green-fg">In[9], line 23</span>
...
<span class="ansi-green-fg">---&gt; 23</span> meanfield_advi <span style="color: rgb(98,98,98)">=</span> <span class="ansi-yellow-bg">build_mf_advi</span><span class="ansi-yellow-bg">(</span><span class="ansi-yellow-bg">)</span>

Cell <span class="ansi-green-fg">In[9], line 3</span>, in <span class="ansi-cyan-fg">build_mf_advi</span><span class="ansi-blue-fg">()</span>
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[10]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="n">unconstraining_bijectors</span> <span class="o">=</span> <span class="p">[</span>
...
<div id="cell-10" class="clipboard-copy-txt">unconstraining_bijectors = [
  tfb.Exp(),
  tfb.Identity()
]
...
<span class="ansi-green-intense-fg ansi-bold">      1</span> unconstraining_bijectors <span style="color: rgb(98,98,98)">=</span> [
<span class="ansi-green-fg">----&gt; 2</span>   <span class="ansi-yellow-bg">tfb</span><span style="color: rgb(98,98,98)">.</span>Exp(),
<span class="ansi-green-intense-fg ansi-bold">      3</span>   tfb<span style="color: rgb(98,98,98)">.</span>Identity()
<span class="ansi-green-intense-fg ansi-bold">      4</span> ]
<span class="ansi-green-intense-fg ansi-bold">      6</span> posterior <span style="color: rgb(98,98,98)">=</span> make_transformed_log_prob(
<span class="ansi-green-intense-fg ansi-bold">      7</span>     joint_log_prob,
<span class="ansi-green-intense-fg ansi-bold">      8</span>     unconstraining_bijectors,
<span class="ansi-green-intense-fg ansi-bold">      9</span>     direction<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(175,0,0)">&#39;</span><span style="color: rgb(175,0,0)">forward</span><span style="color: rgb(175,0,0)">&#39;</span>,
<span class="ansi-green-intense-fg ansi-bold">     10</span>     enable_bijector_caching<span style="color: rgb(98,98,98)">=</span><span class="ansi-bold" style="color: rgb(0,135,0)">False</span>
<span class="ansi-green-intense-fg ansi-bold">     11</span> )
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[11]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="n">opt</span> <span class="o">=</span> <span class="n">tf</span><span class="o">.</span><span class="n">optimizers</span><span class="o">.</span><span class="n">Adam</span><span class="p">(</span><span class="n">learning_rate</span><span class="o">=</span><span class="mf">.1</span><span class="p">)</span>
...
<span class="k">def</span> <span class="nf">run_approximation</span><span class="p">():</span>
...
<div id="cell-11" class="clipboard-copy-txt">opt = tf.optimizers.Adam(learning_rate=.1)
...
<span class="ansi-green-fg">----&gt; 1</span> opt <span style="color: rgb(98,98,98)">=</span> <span class="ansi-yellow-bg">tf</span><span style="color: rgb(98,98,98)">.</span>optimizers<span style="color: rgb(98,98,98)">.</span>Adam(learning_rate<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(98,98,98)">.1</span>)
<span class="ansi-green-intense-fg ansi-bold">      3</span> <span style="color: rgb(175,0,255)">@tf</span><span style="color: rgb(98,98,98)">.</span>function(autograph<span style="color: rgb(98,98,98)">=</span><span class="ansi-bold" style="color: rgb(0,135,0)">False</span>)
<span class="ansi-green-intense-fg ansi-bold">      4</span> <span class="ansi-bold" style="color: rgb(0,135,0)">def</span> <span style="color: rgb(0,0,255)">run_approximation</span>():
<span class="ansi-green-intense-fg ansi-bold">      5</span>     elbo_loss <span style="color: rgb(98,98,98)">=</span> tfp<span style="color: rgb(98,98,98)">.</span>vi<span style="color: rgb(98,98,98)">.</span>fit_surrogate_posterior(
<span class="ansi-green-intense-fg ansi-bold">      6</span>         posterior,
<span class="ansi-green-intense-fg ansi-bold">      7</span>         surrogate_posterior<span style="color: rgb(98,98,98)">=</span>meanfield_advi,
<span class="ansi-green-intense-fg ansi-bold">      8</span>         optimizer<span style="color: rgb(98,98,98)">=</span>opt,
<span class="ansi-green-intense-fg ansi-bold">      9</span>         sample_size<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(98,98,98)">200</span>,
<span class="ansi-green-intense-fg ansi-bold">     10</span>         num_steps<span style="color: rgb(98,98,98)">=</span><span style="color: rgb(98,98,98)">10000</span>)
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[12]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="n">plt</span><span class="o">.</span><span class="n">plot</span><span class="p">(</span><span class="n">elbo_loss</span><span class="p">,</span> <span class="n">color</span><span class="o">=</span><span class="s1">&#39;blue&#39;</span><span class="p">)</span>
...
<div id="cell-12" class="clipboard-copy-txt">plt.plot(elbo_loss, color='blue')
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[13]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="n">graph_info</span> <span class="o">=</span> <span class="n">model</span><span class="o">.</span><span class="n">resolve_graph</span><span class="p">()</span>
...
<div id="cell-13" class="clipboard-copy-txt">graph_info = model.resolve_graph()
approx_param = dict()
...
<div class="jp-InputPrompt jp-InputArea-prompt">In&nbsp;[14]:</div><div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
        ...
        <div class="zeroclipboard-container">
            ...
            <div class="highlight-ipynb hl-python"><pre><span></span><span class="nb">print</span><span class="p">(</span><span class="n">approx_param</span><span class="p">)</span>
</pre></div>
<div id="cell-14" class="clipboard-copy-txt">print(approx_param)</div>
